...
export default function RegistracijaPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-primary-100/80 to-primary-300/60 dark:from-primary-900/80 dark:to-primary-700/60 relative">
      <header className="flex flex-col items-center mt-16 mb-8 select-none">
      ...
      <Card className={cn("w-[430px] max-w-full h-[420px] px-8 py-8 mx-auto shadow-2xl glassmorphism border-none bg-white/70 dark:bg-primary-950/80 backdrop-blur-lg animate-fade-in-up flex flex-col justify-center items-center")}> 
        <CardHeader className="flex justify-center">
          <CardTitle className="text-3xl font-extrabold text-center text-black dark:text-white tracking-tight">Registracija</CardTitle>
        </CardHeader>
        <CardContent>
