...
const UrediUgovorModal: React.FC<Props> = ({ open, onClose, onSave, ugovor }) => {
  ...
  const [valuta, setValuta] = useState(ugovor.valuta || "RSD");
  ...
  useEffect(() => {
    if (open && ugovor) {
      ...
      setSlika(ugovor.fotografija || null);
      setSektor(ugovor.sektor || SEKTORI[0].label);
      setValuta(ugovor.valuta || "RSD");

    }
  }, [open, ugovor, initialErrors]);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ pointerEvents: 'auto' }}>
      ...
      <div className="relative bg-white rounded-xl shadow-lg w-full max-w-4xl max-h-[90vh] overflow-hidden z-50">
        ...
        <div className="flex justify-between items-center p-6">
          <h2 className="text-2xl font-bold">Uredi ugovor</h2>
...
export default UrediUgovorModal; 